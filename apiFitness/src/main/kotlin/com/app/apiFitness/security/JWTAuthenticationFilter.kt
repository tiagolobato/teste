package com.app.apiFitness.security

import com.app.apiFitness.constants.authorization
import com.app.apiFitness.constants.bearer
import com.app.apiFitness.model.Credentials
import com.app.apiFitness.model.UserDetailsImpl
import com.app.apiFitness.utils.JWTUtil
...
class JWTAuthenticationFilter: UsernamePasswordAuthenticationFilter {
    ...
    override fun attemptAuthentication(request: HttpServletRequest, response: HttpServletResponse?): Authentication? {
        try {
            ...
            throw UsernameNotFoundException("User not found!") as Throwable
        }
    }
